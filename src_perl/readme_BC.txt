===============================================================================
【ソフト名】  ゲーム設定型ダイスボット「ボーンズ＆カーズ(bcdice.pl)」Ver.1.2.43
【著作権者】  Faceless
...
4.更新履歴：
Ver1.2.45 2011/09/11
・ネクロニカ製品版に「パーツ損傷」のルールを合わせた。

Ver1.2.44 2011/09/05
・モノトーンミュージアムが選択できなくなっていたバグの修正。(Thanks! 竹流さん)

Ver1.2.43 2011/08/27
・モノトーンミュージアムに対応。(Thanks! akiyukiさん)

Ver1.2.42 2011/07/18
・パラサイトブラッドに誤作動表を追加。(Thanks! 超小兎さん)

Ver1.2.41 2011/07/18
・ネクロニカの大失敗判定ロジックをFAQの記述に合わせた。

Ver1.2.40 2011/07/17
・六門世界2nd.Editionに対応(Thanks! ベニーさん)

Ver1.2.39 2011/07/11
・マギカロギアにランダム特技決定表を追加(Thanks! MASASHIGEさん)

Ver1.2.38 2011/07/08
・ダークブレイズのDBコマンドのBugFix(Thanks! 竹流さん)

Ver1.2.37 2011/07/03
・まよきんのアイテム特性表のBugFix(Thanks! sillygoさん)

Ver1.2.36 2011/06/23
・ゲヘナ・アナスタシスの「幸運の助け」のBugFix(Thanks! Ragiさん)

Ver1.2.35 2011/06/23
・まよきんの相場表のBugFix(Thanks! sakaixさん)
・迷宮デイズのカーネル停止表のBugFix(Thanks! sillygoさん)

Ver1.2.34 2011/06/13
・TORGのボーナス処理のBugFix(Thanks! 竹流さん)

Ver1.2.33 2011/06/07
・バルナ・クロニカに対応。

Ver1.2.32 2011/06/05
・迷宮キングダムの表を追加。(Thanks! 765aことanachroさん)
・サタスペの一部コマンドがシークレット表示されるバグの修正。(Thanks! siiaaglさん)

Ver1.2.31 2011/05/29
・ピーカブーに対応。(Thanks! sillygoさん)
・迷宮デイズの判定結果表示の実装忘れをFix。

Ver1.2.30 2011/05/28
...
Ver1.2.29 2011/05/08
・ネクロニカのパーツ損傷処理のバグ修正。(Thanks! 竹流さん)

Ver1.2.28 2011/05/07
・ネクロニカに対応。判定と攻撃判定のみ。
・マギカロギアのソートモードを3に変更した。(Thanks! TacoSuke_10_9さん)

Ver1.2.27 2011/05/07
・マギカロギアの魔素獲等と判定結果表示を追加。(Thanks! MASASHIGEさん)

Ver1.2.26 2011/05/02
・マギカロギアに対応。基本ルルブの各種表を実装。

Ver1.2.25 2011/04/30
・シノビガミに「死」で追加されたシーン表を追加
・シノビガミに「乱」で追加された変調表を追加

Ver1.2.24 2010/01/16
・迷宮キングダムの「魅力休憩表」の記述に間違いやすい文章があったのを修正。(Thanks! 狐猫さん)
