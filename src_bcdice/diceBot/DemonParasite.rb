    ...
    if(urge_type <= 1)
      ...
      return [[
        ...
        [
          ...
          '『自虐』自分が許せない。自分へ素手攻撃(自動命中。ダメ个アジは通常)。[20点]',
      ...
      return [[
        ...
        [
          ...
          '『治癒』疲れが癒される。[0点]',
          '『本能』暴力衝動に駆られ、瞬時に懼化"してしまう。[10轤ケ]',
          '縲守砕』破壊衝動が巻き起こり、目の前の障害物を破壊する。[20点]',
        ...
        [
          ...
          '『覚醒』1時間、全身から閃光を発し、高さが【精神】mの懼蜈峨譟ア"縺ォ蛹⒤∪繧後ｋ縲30轤ケ]',
        ]]
    else                     # 鬯シ蠕。鬲戦闘中)衝動表
      return [[
        ...
        [
          ...
          '『抑制』影響なし。',
          '『治癒』【エナジー】を5点回復する。',
          '『本能』即座に懼逡ー蠖「蛹、ターン終了まで任意のダメージ1つに「+1d」点。',
